...
# Load datasets
trends_data = pd.read_csv('data/bcgx_financial_data_2020_2025.csv')
summary_trends_data = pd.read_csv('data/summary_trends_data.csv')
...
def handle_query():
    ...
    def financial_chatbot():
        ...
        if user_query == "total revenue":
            ...
            return f"The Year By Year Average Revenue Growth Rate(%) from 2020 to 2025 for {company_input} is {result}%"
            ...
            return f"The Year By Year Net Income Growth Rate(%) from 2020 to 2025 for {company_input} is {result}%"
            ...
            return f"The Year By Year Average Assets Growth Rate(%) from 2020 to 2025 for {company_input} is {result}%"
            ...
            return f"The Year By Year Average Liabilities Growth Rate(%) from 2020 to 2025 for {company_input} is {result}%"
            ...
            return f"The Year By Year Average Cash Flow from Operations Growth Rate(%) from 2020 to 2025 for {company_input} is {result}%"
